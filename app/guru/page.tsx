...
export default function GuruDashboard() {
  ...
  <span className="shrink-0 font-bold">Profil Akademik:</span>
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 print:text-black print:bg-none font-bold uppercase truncate min-w-0">
